...
struct OnboardingLocations: View {
    ...
    var body: some View {
        ClippyBox(title: "I support local".t(), subTitle: "Clippy will show you from where your product orginate".t(), backColor: SettingsView.MigrosColorWhite, foreColor: Color.black, image: Image("location-OK") ) {
